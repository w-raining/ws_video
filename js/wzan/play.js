...
function wsPlayer(conf){
    ...
    conf.mediaid='wsplayer_uid_base'+AODIANPLAY_UUID_BASE;
    //判断手机还是pc
    ...
    if(isPc){
        if(conf.rtmpUrl && conf.rtmpUrl != ''){
            ...
            lssFunInterval = setInterval(function(){
                ...
                var playerScript = '/livecontent/aodianplay/' + playername + '.js'; //LSS_SITE + '/lss/aodianplay/' + playername + '.js';
        ...
        if(conf.hlsUrl && conf.hlsUrl != ''){
            ...
            html5FunInterval = setInterval(function(){
                ...
                if (!window.sourceurl) {
                    window.sourceurl = "/livecontent";
                }
                var playerScript = sourceurl+ '/aodianplay/html5player.js';
                var layoutScript = document.createElement('script');
                layoutScript.type = 'text/javascript';
                layoutScript.charset = 'UTF-8';
                layoutScript.src = playerScript;
